...
public class Ask extends RefActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        account = getAccount();
    	if(!isLogin())	notsetting(Ask.this);
...
//    	if(!isLogin())	notsetting(Ask.this);
	...
	private void findview() {
    	...
    	if ( !account.isAccountCanPostPic()){
...
//    	photo.recycle();
	...
	protected void sending_ask() {
		...
		if(action_type.equals("q")){
			...
			params.add(new BasicNameValuePair("accid",account.getUserid()));
			...
			params.add(new BasicNameValuePair("tid",themeSelected.getId()));
