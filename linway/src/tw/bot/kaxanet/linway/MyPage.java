...
public class MyPage extends RefActivity {
	...
	private void findview() {
		...
		thTab.addTab(thTab.newTabSpec("question").setIndicator(createTabView(this, this.getString(R.string.my_questions))).setContent(R.id.listView));
		thTab.addTab(thTab.newTabSpec("reply").setIndicator(createTabView(this, this.getString(R.string.my_reply))).setContent(R.id.listView1));
	    thTab.addTab(thTab.newTabSpec("Subscribe").setIndicator(createTabView(this, this.getString(R.string.my_subscribe))).setContent(R.id.listView2));
	...
	public class MyPageAdapter extends BaseAdapter {
    	...
    	public View getView(final int position, View view, ViewGroup parent) {
    		...
    		holder.label_3.setText(data.get(position).get("date").toString());
    		if(idx==1){
    			holder.label_2.setText(data.get(position).get("asker").toString());
    		}
    		if(idx==2){
    			holder.label_2.setText(data.get(position).get("replier").toString());
    		}
