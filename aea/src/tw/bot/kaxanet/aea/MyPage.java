...
import tw.bot.kaxanet.aea.MyListView.OnRefreshListener;
...
public class MyPage extends RefActivity {
	...
	public class MyPageAdapter extends BaseAdapter {
    	...
    	public View getView(final int position, View view, ViewGroup parent) {
    		...
    		holder.arrow.setImageBitmap(BitmapFactory.decodeResource(getBaseContext().getResources(),tw.bot.kaxanet.aea.R.drawable.arrow));
