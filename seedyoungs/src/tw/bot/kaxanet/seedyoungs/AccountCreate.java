        ...
        public void handleMessage(Message msg) {
        	...
        	case 222:
        		...
        		if(login_check) {
        			...
        			builder.setMessage("帳號註冊成功!!");
        			builder.setCancelable(false);
        			builder.setPositiveButton("立即設定", new DialogInterface.OnClickListener() {
